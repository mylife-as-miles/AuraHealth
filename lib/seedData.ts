...
export const MOCK_DIAGNOSTIC_CASES: DiagCase[] = [
    {
        ...
        status: 'Critical',
        time: '10:42 AM',
        image: 'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?auto=format&fit=crop&w=300&q=80',
        totalSlices: 124,
        confidence: 94,
        modelName: 'CardioAI v2.1',
        timestamp: Date.now(),
        findings: [{ severity: 'critical', title: 'Embolism Detected', description: 'Large obstruction in main pulmonary artery.' }],
        diagnosis: [{ label: 'Pulmonary Embolism', val: 94, color: '#FE5796' }],
        annotations: [{ type: 'point', top: '62%', left: '30%', label: 'Obstruction', confidence: 94, severity: 'critical' }],
        aiSummary: 'Critical finding: Pulmonary Embolism detected.'
    },
    {
        id: '#9921-BR',
        patientId: '#AH-1011',
        ...
        totalSlices: 256,
        confidence: 89,
        modelName: 'NeuroScan v4.0',
        timestamp: Date.now() - 3600000,
        findings: [{ severity: 'info', title: 'Atrophy', description: 'Mild hippocampal atrophy consistent with early Alzheimer\'s.' }],
        diagnosis: [{ label: 'Alzheimer\'s', val: 89, color: '#FE5796' }],
        annotations: [],
        aiSummary: 'Consistent with clinical diagnosis of early-stage Alzheimer\'s.'
    },
    {
        id: '#7721-RX',
        patientId: '#AH-1007',
        ...
        totalSlices: 4,
        confidence: 0,
        modelName: 'OncoVision v3.2',
        timestamp: Date.now() - 1800000,
        findings: [],
        diagnosis: [],
        annotations: [],
        aiSummary: 'Processing images for density analysis...'
    },
    {
        id: '#6612-CT',
        patientId: '#AH-1001',
        ...
        diagnosis: [],
        annotations: [],
        aiSummary: 'Scan scheduled for tomorrow.'
    },
    {
        id: '#5511-XR',
        patientId: '#AH-1017',
        ...
        totalSlices: 1,
        confidence: 98,
        modelName: 'PulmoScan v1.5',
        timestamp: Date.now() - 86400000,
        findings: [{ severity: 'info', title: 'Clear', description: 'No acute cardiopulmonary process.' }],
        diagnosis: [{ label: 'Normal', val: 98, color: '#54E097' }],
        annotations: [],
        aiSummary: 'Lungs are clear. No evidence of pneumonia or edema.'
    }
];
...
export const MOCK_WORKFLOW_CARDS: WorkflowCard[] = [
    {
        ...
        priority: 'urgent',
        scanType: 'ECG Analysis',
        column: 'pending',
        time: '1h ago',
        tags: ['Cardiology', 'Arrhythmia'],
        aiRecommendations: [{ icon: 'alert', title: 'Critical Review', description: 'AFib rate uncontrolled', actionLabel: 'Page Cardiology', actionColor: 'accent' }]
    },
    {
        id: 'wf-2',
        patientId: '#AH-1002',
    ...
    },
    {
        ...
        priority: 'critical',
        scanType: 'Pulmonary Angio',
        column: 'consultation',
        time: '30m ago',
        tags: ['Pulmonology', 'Critical'],
        nextSteps: [{ icon: 'stethoscope', title: 'Admit to ICU', subtitle: 'PE confirmation', color: 'accent' }]
    },
    {
        id: 'wf-4',
        patientId: '#AH-1003',
    ...
    },
    {
        id: 'wf-7',
        patientId: '#AH-1014',
        patientName: 'Tyler Jackson',
        age: 22,
        gender: 'M',
        image: "https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=100&h=100",
        priority: 'stable',
        scanType: 'Insulin Pump Log',
        column: 'treatment',
        time: 'Yesterday',
        tags: ['Endocrinology']
    }
...
export const MOCK_NOTIFICATIONS: NotificationItem[] = [
    {
        ...
        content: 'Potassium levels for James Whitfield (#AH-1004) are 2.9 mmol/L.',
        time: '10 min ago',
        timestamp: Date.now(),
        read: false,
        action: { label: 'Order Electrolytes' }
    },
    {
        id: 'n2',
        type: 'system',
        title: 'Model Update',
        content: 'CardioAI v2.2 deployed successfully.',
        time: '2h ago',
    ...
    },
    {
        ...
        content: 'Dr. Sarah requests cardio consult for Eleanor Voss.',
        time: '3h ago',
    ...
    },
    {
        ...
        content: 'Prepare discharge papers for Robert Tanaka.',
        time: '5h ago',
        timestamp: Date.now() - 18000000,
        read: true,
        action: { label: 'View Draft', secondary: true }
    }
];
